"""BigFormer optimized: cache FP32 weights per block, eliminate 6144 conversions."""
...
print("=== Optimized: cached FP32 weights ===")
...
# Pre-load FP16 weights + biases to GPU
blocks_fp16 = []
for bid in range(24):
...
print(f"  Loaded: {time.perf_counter()-t0:.1f}s  GPU: {torch.cuda.memory_allocated()/1e9:.1f}GB")
...
for start in range(0, N, BATCH_SIZE):
    ...
    for bid in range(24):
        ...
        # ── Convert FP16→FP32 ONCE per block (not 8 times!) ──
