...
## C3.4 内存规划 — 实测验证 (MemoryAwareExecutor)

| 模型 | 中间张量 | Buffer数 | 池大小 | 节省 |
|------|---------|---------|--------|------|
| MLP | 6 | 2 | 0.1MB | 1.4MB (67%) |
| ResNet | 48 | **3** | 0.3MB | **346MB (94%)** |

> 通过 lifetime 分析 → buffer 池复用，ResNet 只需 3 个 buffer 替代 48 个独立分配
